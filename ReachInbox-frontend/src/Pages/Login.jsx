...
export default function Login() {
    const handleGoogleSignIn = () => {
        ...
        const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImVtYWlsIjoicHJhbmF2cHJhdmkyMDAyQGdtYWlsLmNvbSIsImlkIjoxMjk5LCJmaXJzdE5hbWUiOiJQcmFuYXYiLCJsYXN0TmFtZSI6bnVsbH0sImlhdCI6MTcyNDk5NTQ4NiwiZXhwIjoxNzU2NTMxNDg2fQ.eJIqVwn9_P5C4R5iEAWqAdqX_YMdrHxcoPGg8EEy20Y';
